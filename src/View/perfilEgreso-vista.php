        ...
        <div class="row g-0 align-items-center">
            <div class="col-lg-12">
                ...
                <section class="lightSection bg-light p-2">
                    ...
                    <div class="sectionSeparator"></div>
                    <p class="p-3" style="text-align: justify;">Los siguientes objetivos educacionales del programa educativo 
                    en Ingeniería Bioquímica se refieren a los conocimientos, habilidades, actitudes y valores que los egresados 
                    alcanzan en un plazo de 5 años después de su egreso del programa.</p>

                    <div class="row g-0">
                        <div class="col-lg-6 col-sm-6 text-start p-3">
                            <div class="area shadow-sm p-4">
                                <img class="my-3 mx-3" style="float: left;" src="img/iconos/1.png" alt="" height="60px">
                                <p class="textoArea" style="text-align: justify;">Aplica creativamente este dominio de los 
                                principios básicos en la solución de problemas en las diferentes áreas de impacto de 
                                la Ingeniería Bioquímica (Ambiente, Energía, Alimentos, Salud, entre otras).</p>
                            </div>
                        </div>

                        <div class="col-lg-6 col-sm-6 text-start p-3">
                            <div class="area shadow-sm p-4">
                                <img class="my-2 mx-3" style="float: left;" src="img/iconos/2.png" alt="" height="60px">
                                <p class="textoArea" style="text-align: justify;">Aprecia  o es sensible al efecto que decisiones 
                                tienen o pueden tener en temas ambientales, sociales, de seguridad y económicos.</p>
                            </div>
                        </div>

                        <div class="col-lg-6 col-sm-6 text-start p-3">
                            <div class="area shadow-sm p-4">
                                <img class="my-2 mx-3" style="float: left;" src="img/iconos/3.png" alt="" height="60px">
                                <p class="textoArea" style="text-align: justify;">Reconoce el compromiso sobre la importancia de la 
                                superación personal y en consecuencia manifiesta habilidad para el aprendizaje a lo largo de la vida. 
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-sm-6 text-start p-3">
                            <div class="area shadow-sm p-4">
                                ...
                                <p class="textoArea" style="text-align: justify;">Actúa con altos estándares éticos en su práctica profesional.
                                </p>
                            </div>
                        </div>
                    </div>
