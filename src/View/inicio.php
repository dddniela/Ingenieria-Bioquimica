    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption d-flex flex-column">
            <h1 class="mainTitle text-center font-bold m-2 text-stroke">Ingeniería Bioquímica</h1>
            <h2 class="mainSubtitle text-center font-bold text-stroke">Diseña proyectos de ingeniería</h1>
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption">
            <h1 class="mainTitle text-center font-bold m-2 text-stroke">Ingeniería Bioquímica</h1>
            <h2 class="mainSubtitle text-center font-bold text-stroke">Desarrollo de procesos farmacéuticos, alimentarios y ambiente-energía</h1>
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption">
            <h1 class="mainTitle text-center font-bold m-2 text-stroke">Ingeniería Bioquímica</h1>
            <h2 class="mainSubtitle text-center font-bold d-none d-md-inline-flex text-stroke">Movilidad nacional e internacional</h1>
