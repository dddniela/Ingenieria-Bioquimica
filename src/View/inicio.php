...
$docenteImagen1 = $GLOBALS['PATH_DOCENTE'] . 'pabloGonzalezCervantes.webp';
...
$docenteImagen2 = $GLOBALS['PATH_DOCENTE'] . 'yolandaDiazViveros.webp';
...
$docenteImagen3 = $GLOBALS['PATH_DOCENTE'] . 'gracielaBallesterosBarradas.webp';
...
$docenteImagen4 = $GLOBALS['PATH_DOCENTE'] . 'guadalupeRodriguezJimenes.webp';
...
$docenteImagen5 = $GLOBALS['PATH_DOCENTE'] . 'benignoOrtizMuniz.webp';
...
$docenteImagen6 = $GLOBALS['PATH_DOCENTE'] . 'aniluMirandaMedina.webp';
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption">
            <h1 class="mainTitle text-center font-bold m-2 shadow-text">Ingeniería Bioquímica</h1>
            <h2 class="mainSubtitle text-center font-bold shadow-text">Desarrollo de procesos farmacéuticos, alimentarios y ambiente-energía</h1>
...
<section class="lightSection bg-light p-2">
  ...
  <div class="row g-0">
    ...
    <div class="col-lg-4 col-sm-6 text-center p-3">
      <div class="area shadow-sm p-4 rounded-3">
        <a href="?option=5">
          <img class="img-fluid w-90 shadow-1-strong rounded mb-4  p-1" src="img/comunidadIBQ.webp" alt="">
        </a>
